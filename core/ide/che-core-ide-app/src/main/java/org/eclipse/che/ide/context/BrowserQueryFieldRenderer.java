...
public class BrowserQueryFieldRenderer {
    ...
    @Inject
    public BrowserQueryFieldRenderer(ProductInfoDataProvider productInfoDataProvider, Provider<AppContext> appContextProvider) {
    ...
    public void setProjectName(String projectName) {
        ...
        setQueryField(projectName, workspaceName);
    }
    ...
    public native void setQueryField(String projectName, String workspaceName) /*-{
        try {
            ...
            window.top.document.title = (workspaceName.length == 0) ? title : titleWithWorkspaceName;
